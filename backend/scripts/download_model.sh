...
# multilingual-e5-base ONNX 모델 다운로드 스크립트
...
# 설정
MODEL_DIR="$BACKEND_DIR/models/models_e5_base"
BASE_URL="https://huggingface.co/intfloat/multilingual-e5-base/resolve/main"
MAX_RETRIES=3
RETRY_DELAY=2
MIN_FILE_SIZE=900000000  # 900MB (바이트 단위, E5-base는 약 1GB)
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}multilingual-e5-base 모델 다운로드 시작${NC}"
echo -e "${GREEN}========================================${NC}"
